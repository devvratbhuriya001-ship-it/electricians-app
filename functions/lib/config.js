...
exports.TWO_FACTOR_CONFIG = exports.twoFactorApiKeySecret = void 0;
...
exports.twoFactorApiKeySecret = (0, params_1.defineSecret)("TWO_FACTOR_API_KEY");
...
exports.TWO_FACTOR_CONFIG = {
    ...
    SMS_AUTOGEN_URL: (apiKey, phoneNumber) => `https://2factor.in/API/V1/${apiKey}/SMS/${phoneNumber}/AUTOGEN`,
    // SMS OTP verification endpoint:
    // GET https://2factor.in/API/V1/{API_KEY}/SMS/VERIFY/{session_id}/{otp_value}
    SMS_VERIFY_URL: (apiKey, sessionId, otp) => `https://2factor.in/API/V1/${apiKey}/SMS/VERIFY/${sessionId}/${otp}`,
